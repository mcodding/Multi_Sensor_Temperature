 ...
 *	at their discretion. SmartThings gets all credit for the creation of the following code.
 *	My changes only include setting the temperature attribute to be the
 *	main value displayed on the main list of things.
 */
